...
export const metadata = {
  ...
  description:
    "Learn how to use the Dotenvnest CLI to manage your environment variables seamlessly.",
};
...
function CommandDoc({
  ...
  return (
    <div className="border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 bg-white dark:bg-zinc-900/50 shadow-sm hover:shadow-md transition-shadow duration-300">
      ...
      <div className="mb-4">
        <h4 className="text-xs font-bold uppercase tracking-widest text-zinc-500 dark:text-zinc-400 mb-2">
          Example
        </h4>
        ...
        <div>
          ...
          <ul className="space-y-2">
            {options.map((opt, i) => (
              <li
                key={i}
                className="text-sm flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-3"
              >
                <span className="font-mono font-semibold text-zinc-800 dark:text-zinc-300 shrink-0">
                  {opt.name}
                </span>
      ...
      <main className="w-full max-w-4xl">
        <div className="mb-12">
          ...
          <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl">
            The Dotenvnest Command Line Interface (CLI) allows you to securely
            synchronize your{" "}
            <code className="font-mono text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 px-1.5 py-0.5 rounded">
              .env
            </code>{" "}
            files between your local development environment and the cloud.
          </p>
        </div>
        ...
        <section className="space-y-8">
            ...
            options={[
              {
                ...
                desc: "Specify a different file to push (default: .env)",
              },
              {
                name: "--owner <email>",
                desc: "Specify the owner email (only required if there is a name collision)",
              },
            ]}
          />
          ...
          <CommandDoc
            ...
            options={[
              {
                name: "-f, --file <filename>",
                desc: "Specify a different file to output to (default: .env)",
              },
              {
                name: "--owner <email>",
                desc: "Specify the owner email (only required if there is a name collision)",
          ...
          <CommandDoc
            ...
            options={[
              {
                name: "--owner <email>",
                desc: "Specify the owner email (if needed for shared projects)",
              },
            ]}
          />
          ...
          <CommandDoc
            ...
            options={[
              {
                name: "-f, --file <filename>",
                desc: "Specify a different local file to compare (default: .env)",
              },
              {
                name: "--owner <email>",
                desc: "Specify the owner email (if needed for shared projects)",
          ...
          <CommandDoc
            ...
            options={[
              {
                name: "--access <level>",
                desc: "Access level: 'read' or 'edit' (default: read)",
              },
            ]}
          />
        ...
        <section className="mb-16">
          ...
          <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm">
            <p className="text-zinc-600 dark:text-zinc-400 mb-4">
              You can easily integrate <strong>DotEnvNest</strong> into your
              automated pipelines (like GitHub Actions, GitLab CI, or Vercel)
              without needing an interactive browser login.
            </p>
            <p className="text-zinc-600 dark:text-zinc-400 mb-4">
              Simply set the{" "}
              <code className="font-mono text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 px-1.5 py-0.5 rounded">
              ...
              environment variable in your pipeline settings. The CLI will
              automatically use it for authentication.
            </p>
            <CodeBlock>
...
npx dotenvnest pull my-api-server`}
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-500 mt-4 italic">
              * Tip: You can find your personal CLI token inside the
              ~/.dotenvnest-config.json file on your computer after logging in
              locally.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 mb-4">
                By default, the CLI looks for a file named{" "}
                <code className="font-mono text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 px-1.5 py-0.5 rounded">
                  .env
                </code>
              ...
              <p className="text-zinc-600 dark:text-zinc-400 mb-4">
                If you use the <strong>-f</strong> flag to push a variant, the
                CLI automatically maps it to a new project name in the cloud!
              </p>
              <CodeBlock>
...
dotenvnest push my-api -f .env.production`}
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-500 mt-4 italic">
                * Tip: When you run <code>dotenvnest find</code>, you will
                clearly see all your variants listed as separate projects,
                keeping everything perfectly organized.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 mb-4">
                ...
                . Your friend also shares their project named{" "}
                <code className="font-mono text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 px-1.5 py-0.5 rounded">
                  backend
                </code>{" "}
                with you.
...
dotenvnest pull backend --owner friend@email.com`}
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-500 mt-4 italic">
                * Note: The <code>--owner</code> flag works perfectly with{" "}
                <code>push</code>, <code>pull</code>, <code>view</code>, and{" "}
                <code>diff</code>.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 mb-4">
                If your project name contains spaces (e.g.{" "}
                <code className="font-mono text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 px-1.5 py-0.5 rounded">
                  Developer Saif
                </code>
                ), you must wrap the name in double quotes when running CLI
                commands.
              </p>
              <p className="text-zinc-600 dark:text-zinc-400 mb-4">
...
dotenvnest pull "Developer Saif"`}
        ...
        <div className="mt-16 pt-8 border-t border-zinc-200 dark:border-zinc-800 text-center pb-8">
          <p className="text-sm text-zinc-500 dark:text-zinc-500">
            Need help? Feel free to reach out to our support team or check our
            GitHub repository.
          </p>
        </div>
      </main>
